...
# -*- coding: UTF8 -*-
#
# Provides access to alsa seq midi.
...
def snd_seq_ev_clear(ev):
    return memset(ev, 0, sizeof(snd_seq_event_t))
...
def snd_seq_ev_set_dest(ev,c,p):
    ev.contents.dest.client = c
    ev.contents.dest.port = p
...
def snd_seq_ev_set_variable(ev, datalen, dataptr):
    ev.flags &= ~SND_SEQ_EVENT_LENGTH_MASK
    ev.flags |= SND_SEQ_EVENT_LENGTH_VARIABLE
    ev.data.ext.len = datalen
#print dataptr
    ev.data.ext.ptr = cast(dataptr, c_void_p)
...
snd_seq_control_queue = _alsa_lib.snd_seq_control_queue
...
def snd_seq_start_queue(seq, q, ev):
    return snd_seq_control_queue(seq, q, SND_SEQ_EVENT_START, 0, ev)
...
snd_seq_create_simple_port = _alsa_lib.snd_seq_create_simple_port
...
snd_seq_delete_simple_port = _alsa_lib.snd_seq_delete_simple_port
...
snd_seq_disconnect_from = _alsa_lib.snd_seq_disconnect_from
...
snd_seq_disconnect_to = _alsa_lib.snd_seq_disconnect_to
...
snd_seq_set_client_name = _alsa_lib.snd_seq_set_client_name
snd_seq_set_client_name.argtypes = [POINTER(snd_seq_t), c_char_p]
snd_seq_set_client_name.restype = c_int

#int snd_seq_set_client_event_filter(snd_seq_t *seq, int event_type);
snd_seq_set_client_event_filter = _alsa_lib.snd_seq_set_client_event_filter
...
snd_seq_set_client_pool_output = _alsa_lib.snd_seq_set_client_pool_output
...
snd_seq_set_client_pool_output_room = _alsa_lib.snd_seq_set_client_pool_output_room
...
snd_seq_set_client_pool_input = _alsa_lib.snd_seq_set_client_pool_input
...
snd_seq_sync_output_queue = _alsa_lib.snd_seq_sync_output_queue
...
snd_seq_parse_address = _alsa_lib.snd_seq_parse_address
...
snd_seq_reset_pool_output = _alsa_lib.snd_seq_reset_pool_output
snd_seq_reset_pool_output.argtypes = [POINTER(snd_seq_t)]
snd_seq_reset_pool_output.restype = c_int

#int snd_seq_reset_pool_input(snd_seq_t *seq);
snd_seq_reset_pool_input = _alsa_lib.snd_seq_reset_pool_input
