...
_libraries['/usr/lib/libavcodec.so'] = CDLL('/usr/lib/ffmpeg-compat/libavcodec.so')
_libraries['/usr/lib/libavformat.so'] = CDLL('/usr/lib/ffmpeg-compat/libavformat.so')
_libraries['/usr/lib/libavdevice.so'] = CDLL('/usr/lib/ffmpeg-compat/libavdevice.so')
_libraries['/usr/lib/libpostproc.so'] = CDLL('/usr/lib/ffmpeg-compat/libpostproc.so')
_libraries['/usr/lib/libswscale.so'] = CDLL('/usr/lib/ffmpeg-compat/libswscale.so')
STRING = c_char_p
WSTRING = c_wchar_p
