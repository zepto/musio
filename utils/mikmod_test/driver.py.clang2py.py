...
drv_musio.next = None
drv_musio.Name = create_string_buffer(b'drv_musio')
drv_musio.Version = create_string_buffer(b'1.0.0')
drv_musio.HardVoiceLimit = 0
drv_musio.SoftVoiceLimit = 255
drv_musio.Alias = create_string_buffer(b'musio')
drv_musio.CmdLineHelp = None
# drv_musio.CommandLine = POINTER(None)
drv_musio.IsPresent = CFUNCTYPE(BOOL)(mikmod_is_present)
drv_musio.SampleLoad = CFUNCTYPE(SWORD, POINTER(struct_SAMPLOAD), c_int)(VC_SampleLoad)
