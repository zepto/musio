...
DUH_SIGRENDERER_CALLBACK = CFUNCTYPE(
    None, c_void_p, POINTER(POINTER(sample_t)), c_int, c_long
)
...
DUH_SIGRENDERER_ANALYSER_CALLBACK = CFUNCTYPE(
    None, c_void_p, POINTER(POINTER(sample_t)), c_int, c_long
)
...
DUH_SIGRENDERER_SAMPLE_ANALYSER_CALLBACK = CFUNCTYPE(
    None, c_void_p, POINTER(POINTER(sample_t)), c_int, c_long
)
...
duh_sigrenderer_set_sample_analyser_callback = (
    _dumb_lib.duh_sigrenderer_set_sample_analyser_callback
)
duh_sigrenderer_set_sample_analyser_callback.argtypes = [
    POINTER(DUH_SIGRENDERER),
...
duh_sigrenderer_generate_samples.argtypes = [
    POINTER(DUH_SIGRENDERER),
    c_float,
    c_float,
    c_long,
    POINTER(POINTER(sample_t)),
]
...
duh_sigrenderer_get_current_sample.argtypes = [
    POINTER(DUH_SIGRENDERER),
    c_float,
    POINTER(sample_t),
]
...
dumb_it_set_xm_speed_zero_callback.argtypes = [
    POINTER(DUMB_IT_SIGRENDERER),
...
dumb_it_set_midi_callback.argtypes = [
    POINTER(DUMB_IT_SIGRENDERER),
    CFUNCTYPE(c_int, c_void_p, c_int, c_uint),
    c_void_p,
]
...
dumb_it_sd_set_initial_channel_volume.argtypes = [
    POINTER(DUMB_IT_SIGDATA),
    c_int,
    c_int,
]
...
class DUMB_IT_CHANNEL_STATE(Structure):
    _fields_ = [
        ...
        # /* 1-based; 0 if nothing playing, then other fields undef */
        ("sample", c_int),
        ("freq", c_int),  # /* in Hz */
        # /* 1.0 maximum; affected by ALL factors, inc. mixing vol */
        ("volume", c_float),
        ("pan", c_ubyte),  # /* 0-64, 100 for surround */
        # /* use (pan + subpan/256.0f) or ((pan<<8)+subpan) */
        ("subpan", c_char),
        # /* 0-127    cutoff=127 AND resonance=0 */
        ("filter_cutoff", c_ubyte),
        # /* 0-255      -> no filters (subcutoff */
        ("filter_subcutoff", c_ubyte),
        # /* 0-127        always 0 in this case) */
        ("filter_resonance", c_ubyte),
...
dumb_it_sr_get_channel_state.argtypes = [
    POINTER(DUMB_IT_SIGRENDERER),
    c_int,
    POINTER(DUMB_IT_CHANNEL_STATE),
]
...
# long pos
# );
DUH_START_SIGRENDERER = CFUNCTYPE(
    POINTER(sigrenderer_t), POINTER(DUH), POINTER(sigdata_t), c_int, c_long
)
...
# long size, sample_t **samples
# );
DUH_SIGRENDERER_GENERATE_SAMPLES = CFUNCTYPE(
    c_long, POINTER(sigrenderer_t), c_float, c_float, c_long, POINTER(POINTER(sample_t))
)
...
# sample_t *samples
# );
DUH_SIGRENDERER_GET_CURRENT_SAMPLE = CFUNCTYPE(
    None, POINTER(sigrenderer_t), c_float, POINTER(sample_t)
)
...
duh_encapsulate_raw_sigrenderer.argtypes = [
    POINTER(sigrenderer_t),
    POINTER(DUH_SIGTYPE_DESC),
    c_int,
    c_long,
]
...
dumb_remove_clicks.argtypes = [
    POINTER(DUMB_CLICK_REMOVER),
    POINTER(sample_t),
    c_long,
    c_int,
    c_float,
...
dumb_record_click_array.argtypes = [
    c_int,
    POINTER(POINTER(DUMB_CLICK_REMOVER)),
    c_long,
    POINTER(sample_t),
]
...
dumb_record_click_negative_array.argtypes = [
    c_int,
    POINTER(POINTER(DUMB_CLICK_REMOVER)),
    c_long,
    POINTER(sample_t),
...
dumb_remove_clicks_array.argtypes = [
    c_int,
    POINTER(POINTER(DUMB_CLICK_REMOVER)),
    POINTER(POINTER(sample_t)),
    c_long,
...
dumb_click_remover_get_offset_array.argtypes = [
    c_int,
    POINTER(POINTER(DUMB_CLICK_REMOVER)),
    POINTER(sample_t),
]
...
dumb_destroy_click_remover_array.argtypes = [
    c_int,
    POINTER(POINTER(DUMB_CLICK_REMOVER)),
]
...
dumb_reset_resampler.argtypes = [
    POINTER(DUMB_RESAMPLER),
    POINTER(sample_t),
    c_int,
    c_long,
    c_long,
...
dumb_resample_get_current_sample_1_1.argtypes = [
    POINTER(DUMB_RESAMPLER),
    c_float,
    POINTER(sample_t),
]
...
dumb_resample_get_current_sample_1_2.argtypes = [
    POINTER(DUMB_RESAMPLER),
    c_float,
    c_float,
    POINTER(sample_t),
...
dumb_resample_get_current_sample_2_1.argtypes = [
    POINTER(DUMB_RESAMPLER),
    c_float,
    c_float,
    POINTER(sample_t),
...
dumb_resample_get_current_sample_2_2.argtypes = [
    POINTER(DUMB_RESAMPLER),
    c_float,
    c_float,
    POINTER(sample_t),
...
dumb_reset_resampler_16.argtypes = [
    POINTER(DUMB_RESAMPLER),
    POINTER(c_short),
    c_int,
    c_long,
...
dumb_resample_get_current_sample_16_1_1 = (
    _dumb_lib.dumb_resample_get_current_sample_16_1_1
)
dumb_resample_get_current_sample_16_1_1.argtypes = [
    POINTER(DUMB_RESAMPLER),
    c_float,
    POINTER(sample_t),
]
...
dumb_resample_get_current_sample_16_1_2 = (
    _dumb_lib.dumb_resample_get_current_sample_16_1_2
)
dumb_resample_get_current_sample_16_1_2.argtypes = [
    POINTER(DUMB_RESAMPLER),
    c_float,
    c_float,
    POINTER(sample_t),
...
dumb_resample_get_current_sample_16_2_1 = (
    _dumb_lib.dumb_resample_get_current_sample_16_2_1
)
dumb_resample_get_current_sample_16_2_1.argtypes = [
    POINTER(DUMB_RESAMPLER),
    c_float,
    c_float,
    POINTER(sample_t),
...
dumb_resample_get_current_sample_16_2_2 = (
    _dumb_lib.dumb_resample_get_current_sample_16_2_2
)
dumb_resample_get_current_sample_16_2_2.argtypes = [
    POINTER(DUMB_RESAMPLER),
    c_float,
    c_float,
    POINTER(sample_t),
...
dumb_reset_resampler_8.argtypes = [
    POINTER(DUMB_RESAMPLER),
    c_char_p,
    c_int,
    c_long,
...
dumb_resample_get_current_sample_8_1_1 = (
    _dumb_lib.dumb_resample_get_current_sample_8_1_1
)
dumb_resample_get_current_sample_8_1_1.argtypes = [
    POINTER(DUMB_RESAMPLER),
    c_float,
    POINTER(sample_t),
]
...
dumb_resample_get_current_sample_8_1_2 = (
    _dumb_lib.dumb_resample_get_current_sample_8_1_2
)
dumb_resample_get_current_sample_8_1_2.argtypes = [
    POINTER(DUMB_RESAMPLER),
    c_float,
    c_float,
    POINTER(sample_t),
...
dumb_resample_get_current_sample_8_2_1 = (
    _dumb_lib.dumb_resample_get_current_sample_8_2_1
)
dumb_resample_get_current_sample_8_2_1.argtypes = [
    POINTER(DUMB_RESAMPLER),
    c_float,
    c_float,
    POINTER(sample_t),
...
dumb_resample_get_current_sample_8_2_2 = (
    _dumb_lib.dumb_resample_get_current_sample_8_2_2
)
dumb_resample_get_current_sample_8_2_2.argtypes = [
    POINTER(DUMB_RESAMPLER),
    c_float,
    c_float,
    POINTER(sample_t),
...
dumb_reset_resampler_n.argtypes = [
    c_int,
    POINTER(DUMB_RESAMPLER),
    c_void_p,
    c_int,
...
dumb_resample_get_current_sample_n_1_1 = (
    _dumb_lib.dumb_resample_get_current_sample_n_1_1
)
dumb_resample_get_current_sample_n_1_1.argtypes = [
    c_int,
    POINTER(DUMB_RESAMPLER),
    c_float,
    POINTER(sample_t),
...
dumb_resample_get_current_sample_n_1_2 = (
    _dumb_lib.dumb_resample_get_current_sample_n_1_2
)
dumb_resample_get_current_sample_n_1_2.argtypes = [
    c_int,
    POINTER(DUMB_RESAMPLER),
    c_float,
    c_float,
...
dumb_resample_get_current_sample_n_2_1 = (
    _dumb_lib.dumb_resample_get_current_sample_n_2_1
)
dumb_resample_get_current_sample_n_2_1.argtypes = [
    c_int,
    POINTER(DUMB_RESAMPLER),
    c_float,
    c_float,
...
dumb_resample_get_current_sample_n_2_2 = (
    _dumb_lib.dumb_resample_get_current_sample_n_2_2
)
dumb_resample_get_current_sample_n_2_2.argtypes = [
    c_int,
    POINTER(DUMB_RESAMPLER),
    c_float,
    c_float,
...
make_duh.argtypes = [
    ...
    c_char_p * 2,
    c_int,
    POINTER(POINTER(DUH_SIGTYPE_DESC)),
    POINTER(POINTER(sigdata_t)),
]
