...
_libraries = {}
_libraries['/usr/lib/ffmpeg2.8/libavcodec.so'] = CDLL('/usr/lib/libavcodec.so')
STRING = c_char_p
WSTRING = c_wchar_p
_libraries['/usr/lib/ffmpeg2.8/libavdevice.so'] = CDLL('/usr/lib/libavdevice.so')
_libraries['/usr/lib/ffmpeg2.8/libavformat.so'] = CDLL('/usr/lib/libavformat.so')
_libraries['/usr/lib/ffmpeg2.8/libswscale.so'] = CDLL('/usr/lib/libswscale.so')
