...
AV_CH_LOW_FREQUENCY_2 = 34359738368 # Variable c_ulonglong '0x800000000ull'
...
AVERROR_BUFFER_TOO_SMALL = -1397118274 # Variable c_int '-0x053465542'
...
AV_NOPTS_VALUE = -9223372036854775808 # Variable c_longlong '-0x8000000000000000'
...
AVERROR_EXTERNAL = -542398533 # Variable c_int '-0x020545845'
...
int64_t = c_int64
uint8_t = c_uint8
class N8AVPacket4DOT_35E(Structure):
    pass
AVPacket._pack_ = 4
AVPacket._fields_ = [
    ('pts', int64_t),
    ...
    ('stream_index', c_int),
    ('flags', c_int),
    ('side_data', POINTER(N8AVPacket4DOT_35E)),
...
class AVStream(Structure):
    pass
class N8AVStream4DOT_38E(Structure):
    pass
...
AVStream._fields_ = [
    ...
    ('info', POINTER(N8AVStream4DOT_38E)),
    ('pts_wrap_bits', c_int),
...
N8AVStream4DOT_38E._pack_ = 4
N8AVStream4DOT_38E._fields_ = [
    ('last_dts', int64_t),
...
__all__ = ['AVFMT_NOBINSEARCH', 'CODEC_ID_ADPCM_IMA_AMV', 'ETXTBSY',
           'AV_CODEC_ID_TEXT', 'AV_ROUND_UP', 'FF_CODER_TYPE_VLC',
           'avcodec_open', '__OFF64_T_TYPE', 'AV_CODEC_ID_CDXL',
           ...
           'CODEC_ID_TIFF', 'AV_CODEC_ID_PGM', 'AV_CODEC_ID_VBLE',
           'SWS_CS_DEFAULT', 'ADJ_ESTERROR', 'av_iformat_next',
           'gnu_dev_makedev', 'jrand48', 'AV_CODEC_PROP_INTRA_ONLY',
           'FFALIGN', 'avcodec_set_dimensions', 'AV_LOCK_CREATE',
           'AV_CH_TOP_CENTER', 'SWS_CS_SMPTE240M', 'SWS_CS_FCC',
           'pp_free_context', 'av_get_audio_frame_duration',
           '_POSIX_', '____gwchar_t_defined', 'AVCOL_PRI_FILM',
           'asin', 'FF_CMP_CHROMA', 'CODEC_ID_SMACKAUDIO',
           ...
           'fsid_t', 'CODEC_FLAG_QPEL', 'CODEC_CAP_AUTO_THREADS',
           ...
           'AV_CODEC_ID_ADPCM_IMA_EA_SEAD', 'fputs_unlocked', 'tm',
           ...
           'avio_get_str16le', 'MAX_REORDER_DELAY', '_IO_uid_t',
           'AVBitStreamFilter', 'PIX_FMT_VDPAU_WMV3', 'M_PHI',
           'strerror', 'STA_PLL', 'erf', '_IO_FILE', 'CODEC_ID_WMV3',
           ...
           'int_fast16_t', 'PIX_FMT_VAAPI_MOCO', '__fpclassifyl',
           ...
           'LINE_MAX', '_XOPEN_SOURCE',
           'avcodec_default_reget_buffer', 'CODEC_FLAG_PASS1',
           'PIX_FMT_BGR4_BYTE', 'PIX_FMT_UYVY422', 'avio_rl24',
           'CODEC_ID_JPEGLS', '__GLIBC__', 'pthread_rwlockattr_t',
           ...
           'SLICE_FLAG_ALLOW_PLANE', 'ADJ_OFFSET', 'avfilter_link',
           'FF_QSCALE_TYPE_VP56', '_POSIX_NAME_MAX',
           'AV_CODEC_ID_FFMETADATA', 'ELIBMAX', 'CODEC_ID_PCM_F64BE',
           'av_read_packet', 'AV_CODEC_ID_GSM', 'AV_CODEC_ID_SVQ1',
           'AV_CODEC_ID_SVQ3', 'PIX_FMT_MONOWHITE',
           'AV_CODEC_ID_PCM_S24BE', 'strtouq', 'avio_read', 'ENOTTY',
           'CODEC_CAP_FRAME_THREADS', '_IONBF', 'finitef',
           'AV_CODEC_ID_PAF_VIDEO', 'STA_INS',
           ...
           '_POSIX_SOURCE', 'CODEC_ID_IFF_ILBM', 'logb', 'sinhf',
           'fileno_unlocked', 'logl', 'sws_addVec', 'WIFSIGNALED',
           'sinhl', 'av_find_stream_info', 'CODEC_ID_DIRAC', 'pid_t',
           'MB_TYPE_INTRA_PCM', 'uint_fast32_t', '__INO64_T_TYPE',
           'div_t', 'ceill', 'AV_CODEC_ID_THP', 'sprintf', 'atol',
           'av_free_packet', 'AVFMT_NOSTREAMS',
           'av_frame_set_best_effort_timestamp', 'CHARCLASS_NAME_MAX',
           'STA_CLOCKERR', 'LIBSWSCALE_VERSION_MICRO',
           'AV_CODEC_ID_CMV', 'log2', 'strcspn', 'AV_CODEC_ID_OPUS',
           'AV_CPU_FLAG_SSSE3', 'strchrnul', 'PIX_FMT_GBRP10BE',
           'AV_CODEC_ID_MJPEGB', 'lldiv_t', 'L_cuserid',
           'av_get_picture_type_char', 'MB_TYPE_INTERLACED',
           'av_frame_get_channel_layout', 'AV_CODEC_ID_8SVX_RAW',
           '_IOS_OUTPUT', 'CODEC_ID_ZEROCODEC', 'CODEC_ID_MSZH',
           'LIBAVFILTER_VERSION_MICRO', 'htobe16', 'erff',
           ...
           'exp2', 'AV_AUDIO_SERVICE_TYPE_VOICE_OVER', 'qsort',
           'PIX_FMT_ARGB', 'avio_printf', 'isalpha', 'ino64_t',
           'AV_CODEC_ID_GSM_MS', 'memcmp', 'EISNAM', 'dprintf',
           'ecvt_r', 'FF_IDCT_SIMPLEVIS', '_POSIX_PATH_MAX',
           'setbuffer', 'av_append_packet', 'clock_adjtime',
           'AV_CODEC_ID_DIRAC', 'avio_flush', '__blkcnt64_t',
           'mkostemp', 'isascii', 'AV_CODEC_ID_SONIC_LS',
           'BC_DIM_MAX', 'AV_CODEC_ID_EIA_608', 'CODEC_ID_SUNRAST',
           ...
           'SWS_BILINEAR', 'AV_CODEC_ID_TARGA', 'AVFMT_NO_BYTE_SEEK',
           '__rlim_t', '__FLOAT_WORD_ORDER', 'CODEC_ID_8SVX_EXP',
           'setstate', 'ENONET', 'STA_FLL',
           'FF_BUFFER_HINTS_READABLE', 'AV_EF_COMPLIANT',
           '__isspace_l', 'AVCOL_TRC_GAMMA28',
           'FF_PROFILE_MPEG4_SIMPLE_FACE_ANIMATION', 'ESRCH',
           'PIX_FMT_BGR48LE', 'CODEC_ID_MJPEG', 'av_destruct_packet',
           'SWS_CPU_CAPS_MMX', '__clockid_t', 'STA_MODE',
           ...
           'CODEC_ID_TSCC2', '_POSIX_AIO_MAX', 'FF_QSCALE_TYPE_MPEG2',
           ...
           'PIX_FMT_YUV422P10BE', 'setvbuf', 'av_strdup',
           ...
           'AV_DISPOSITION_LYRICS', 'AV_CODEC_ID_EXR', 'abs',
           'SWS_PRINT_INFO', 'AV_MATRIX_ENCODING_DPLII',
           'FF_IDCT_ALTIVEC', 'AVPicture', 'av_log_default_callback',
           ...
           'lgammal', 'ceil', 'av_codec_get_codec_descriptor',
           'UINT_MAX', 'ptsname_r', 'AV_CODEC_ID_AVUI',
           'AV_CODEC_ID_WEBVTT', 'SWS_ACCURATE_RND', 'fmaf',
           'mkstemps64', 'perror', 'srandom', 'pthread_condattr_t',
           'AV_CODEC_ID_CELT', '_tolower', 'avcodec_register_all',
           'PIX_FMT_GBR24P', 'avcodec_decode_audio3',
           'SWS_CPU_CAPS_BFIN', 'EINVAL', 'PIX_FMT_YUV444P16BE',
           '__timer_t', 'strncmp', 'av_get_exact_bits_per_sample',
           'mkdtemp', 'AVLINK_UNINIT', 'CODEC_ID_FLASHSV',
           'AV_CODEC_ID_ANM', 'avio_r8', 'sws_getIdentityVec',
           'AVCodecDescriptor', 'avcodec_default_execute',
           'AVProbeData', 'ENOTNAM', 'AVFieldOrder', 'AVLockOp',
           '_LIB_VERSION', 'sws_freeFilter',
           'avformat_match_stream_specifier', '_IO_seekpos',
           '_IO_pos_t', 'erfcf', 'posix_memalign', 'avfilter_free',
           'AV_CODEC_ID_FLV1', 'CODEC_ID_GIF', 'CODEC_ID_PCM_S32BE',
           'FP_INFINITE', 'av_filename_number_test', '_POSIX_ARG_MAX',
           'M_LOG2_10', 'AV_CODEC_ID_BMV_AUDIO', '__uint32_t',
           ...
           'CODEC_ID_PCM_S24DAUD', 'CODEC_ID_FIRST_SUBTITLE', 'ctime',
           'LIBPOSTPROC_VERSION_MICRO', 'CODEC_ID_QTRLE',
           'N8AVPacket4DOT_35E', 'PIX_FMT_RGB555LE', 'float_t',
           'AVCOL_SPC_SMPTE240M', 'PIX_FMT_GRAY16BE',
           '_ISOC99_SOURCE', 'avcodec_encode_subtitle', 'freopen',
           'PIX_FMT_YUV444P9BE', 'fread_unlocked', 'AV_CODEC_ID_R10K',
           ...
           'FF_DEBUG_MV', 'MB_TYPE_P0L1', 'MB_TYPE_P0L0',
           ...
           'AVColorTransferCharacteristic', '_POSIX_AIO_LISTIO_MAX',
           'sws_getCachedContext', 'ftello', 'MOD_FREQUENCY',
           'AVIO_FLAG_DIRECT', 'initstate', 'timezone',
           ...
           'FF_LOSS_CHROMA', 'AVFormatContext',
           ...
           'ENOTBLK', 'LONG_LONG_MIN', 'AVChromaLocation',
           ...
           'CODEC_ID_AAC', 'AV_CPU_FLAG_SSE', '_G_ssize_t',
           ...
           'CODEC_ID_EIA_608', 'CODEC_ID_TSCC', 'EDEADLOCK',
           'cuserid', 'av_packet_shrink_side_data',
           'CODEC_FLAG_LOW_DELAY', 'av_resample_init', 'AVStream',
           ...
           'CODEC_ID_INTERPLAY_VIDEO', 'CODEC_ID_WMV2',
           ...
           'CODEC_ID_PCM_F32BE', '__int8_t', '__FSFILCNT64_T_TYPE',
           'AV_SAMPLE_FMT_FLT', 'STA_PPSFREQ',
           'AVFILTER_CMD_FLAG_ONE', '_MATH_H', 'avio_open',
           'CODEC_ID_HDMV_PGS_SUBTITLE', 'av_write_frame',
           'AV_CODEC_ID_IFF_BYTERUN1', 'ftrylockfile',
           'CODEC_ID_ZMBV', 'AV_CODEC_ID_NELLYMOSER',
           ...
           'PIX_FMT_YUV420P16LE', 'feof', 'strncat',
           ...
           'llround', 'AVCOL_RANGE_UNSPECIFIED', 'av_get_packet',
           'uint', 'AV_CODEC_ID_V210', 'FF_CMP_RD',
           'AVDISCARD_NONREF', '_G_off64_t', 'strncasecmp_l',
           'AVCHROMA_LOC_TOP', 'strcasecmp',
           'AV_CODEC_ID_PCM_S8_PLANAR', 'FF_PROFILE_AAC_LD',
           'AV_CODEC_ID_QPEG', 'stdin', 'CODEC_ID_CDGRAPHICS',
           'AV_CODEC_ID_TMV', 'FF_LOSS_RESOLUTION', 'gamma',
           'CODEC_ID_AMR_WB', 'suseconds_t', 'FF_DEBUG_PTS',
           'EHOSTUNREACH', '__mempcpy', 'AVMatrixEncoding',
           ...
           'FILE', 'CODEC_ID_CMV', 'size_t', 'seed48', 'MAX_INPUT',
           'CODEC_FLAG_4MV', 'AV_CODEC_ID_TQI',
           'AVMEDIA_TYPE_ATTACHMENT', 'CODEC_ID_RL2', 'roundf',
           'AV_CH_BACK_CENTER', 'AV_CODEC_ID_WAVPACK',
           'CODEC_FLAG_QP_RD', 'PIX_FMT_VDPAU_MPEG1', 'PIX_FMT_BGR4',
           'FF_CMP_DCT264', 'PIX_FMT_VDPAU_MPEG2', 'CODEC_ID_V308',
           'sws_init_context', 'CODEC_ID_MP3ON4', 'CODEC_ID_FLV1',
           'fileno', '__swblk_t', '__isblank_l', 'AV_CODEC_ID_NONE',
           'PIX_FMT_BGRA', 'CODEC_ID_PCM_S16LE_PLANAR',
           'PARSER_FLAG_ONCE', 'FF_DTG_AFD_16_9', 'AVFMT_FLAG_IGNIDX',
           ...
           'avformat_new_stream', 'CHAR_MIN', '__USE_POSIX',
           ...
           'AV_CODEC_ID_ADPCM_IMA_APC', 'avcodec_encode_video',
           'UCHAR_MAX', 'SWS_CPU_CAPS_MMX2', 'FFUMOD',
           ...
           'u_int32_t', 'AV_CODEC_ID_MLP', 'EREMOTE', 'asprintf',
           'FF_CMP_NSSE', '_IO_cookie_io_functions_t',
           'CODEC_CAP_CHANNEL_CONF', '_SYS_TYPES_H', '__P',
           'asctime_r', 'CODEC_ID_SNOW', '_IO_ERR_SEEN', 'remainder',
           'AVSideDataParamChangeFlags', 'toupper_l',
           ...
           'PIX_FMT_0BGR', '__FD_ELT', '__toupper_l', 'AV_FIELD_TT',
           ...
           '__UQUAD_TYPE', 'AVSTREAM_PARSE_TIMESTAMPS', 'AV_JOIN',
           ...
           '_XLOCALE_H', 'logbf', 'AV_CPU_FLAG_ARMV6T2', 'logbl',
           'CODEC_ID_DXTORY', 'bcopy', '__finitel',
           ...
           'ECONNRESET', 'AVCHROMA_LOC_CENTER', 'av_new_program',
           'mkstemps', '__STDC_IEC_559_COMPLEX__', 'MOD_OFFSET',
           '_IO_LINE_BUF', 'AV_DISPOSITION_KARAOKE',
           'CODEC_CAP_SLICE_THREADS', 'AV_CODEC_ID_PAF_AUDIO',
           'av_probe_input_format2', 'intptr_t', 'l64a',
           '_G_config_h', 'AV_PKT_DATA_SKIP_SAMPLES',
           '_IO_FLAGS2_MMAP', 'M_LN2',
           ...
           'AV_CODEC_ID_INTERPLAY_DPCM', 'avio_open_dyn_buf',
           ...
           'AV_PKT_DATA_H263_MB_INFO', 'AV_CODEC_ID_WMV3IMAGE',
           '__USE_XOPEN2K', 'cookie_read_function_t', 'avcodec_open2',
           'jn', 'CODEC_FLAG_LOOP_FILTER', 'stime', 'AVProfile',
           'ME_HEX', 'avcodec_descriptor_get_by_name', 'pp_mode',
           ...
           'AV_SIDE_DATA_PARAM_CHANGE_DIMENSIONS', 'vasprintf', 'pow',
           'strxfrm', 'AVCHROMA_LOC_TOPLEFT', 'ff_log2_tab',
           ...
           'sws_scaleVec', 'av_usleep', 'AV_CODEC_ID_RA_144',
           ...
           'AV_CODEC_ID_DSICINVIDEO', 'vsscanf', 'qfcvt',
           ...
           'AVDurationEstimationMethod', 'AV_CODEC_ID_ILBC',
           ...
           'fgets', 'AV_CODEC_ID_R210', 'CODEC_ID_AVRP',
           ...
           'AV_CODEC_ID_WMAV2', '__inline_mathop_',
           'avfilter_pad_get_name', 'int_least16_t',
           'CODEC_CAP_HWACCEL', 'strerror_l', 'log1pl',
           'PIX_FMT_BGR444BE', 'AV_FIELD_PROGRESSIVE',
           'AV_CODEC_ID_DXA', 'AV_CODEC_ID_VC1',
           'av_sample_fmt_is_planar', 'CODEC_FLAG2_LOCAL_HEADER',
           'log1pf', 'tgammaf', '_CTYPE_H', 'FF_BUG_DIRECT_BLOCKSIZE',
           'fgetpos', 'SWS_BICUBIC', 'CODEC_ID_VMNC',
           'avfilter_get_by_name', '_IOFBF', 'AVFMT_FLAG_GENPTS',
           'AVERROR', 'strverscmp', 'avdevice_version',
           ...
           'PIX_FMT_RGB48BE', 'FF_PROFILE_H264_BASELINE',
           ...
           'AV_CODEC_ID_PCM_S16LE_PLANAR', 'CODEC_ID_COOK',
           'tolower_l', 'AVERROR_OPTION_NOT_FOUND', 'fcvt_r',
           '_IO_vfscanf', 'PIX_FMT_YUV444P',
           ...
           'AV_CODEC_ID_GIF', '__WCHAR_MIN', 'av_parse_cpu_caps',
           '__GNUC_PREREQ', 'EBADF', 'EBADE', '__BLKCNT64_T_TYPE',
           'CODEC_FLAG_CBP_RD', 'sws_alloc_context',
           'AV_CODEC_ID_FLASHSV2', 'CODEC_CAP_TRUNCATED',
           '__PDP_ENDIAN', 'EBADR', 'avfilter_uninit',
           'AV_CODEC_ID_FFVHUFF', 'vfscanf', 'AV_CH_FRONT_CENTER',
           'PIX_FMT_RGBA64LE', 'EXDEV', 'avio_w8', '__pid_t',
           '__va_arg_pack', 'avio_open2', 'time', '_SIGSET_NWORDS',
           ...
           'FF_CODER_TYPE_RAW', 'FF_IDCT_BINK', 'CODEC_ID_SMC',
           'STA_PPSWANDER', '_IO_USER_LOCK', 'AV_CODEC_ID_PNG',
           'int_fast32_t', 'acosl', 'PIX_FMT_RGBA64BE', 'acosh',
           'acosf', 'AV_CH_LAYOUT_OCTAGONAL', 'AVERROR_EOF',
           'nearbyint', 'CODEC_ID_ADPCM_IMA_ISS', 'avio_rl32',
           '__WCOREFLAG', 'uint8_t', 'AV_CODEC_ID_AC3',
           '_G_HAVE_MREMAP', 'CODEC_FLAG_AC_PRED',
           'FF_PROFILE_AAC_LOW', 'strptime', 'EINPROGRESS',
           'AV_SAMPLE_FMT_DBLP', 'mktime', 'AV_CH_LAYOUT_SURROUND',
           ...
           'AVFMT_FLAG_NONBLOCK', 'random', '_IO_jump_t', '_ISdigit',
           ...
           'AVDISCARD_BIDIR', '__expm1l', 'llroundl',
           ...
           '_IO_SKIPWS', '__WIFEXITED', 'av_get_packed_sample_fmt',
           ...
           'AV_CPU_FLAG_MMX2', 'select', 'CODEC_ID_TGQ', 'AVFrame',
           'AVFMT_NOFILE', 'canonicalize_file_name',
           'CODEC_CAP_INTRA_ONLY', 'cfree', 'AV_SAMPLE_FMT_U8P',
           ...
           'AVCOL_TRC_GAMMA22', 'roundl', '__secure_getenv',
           ...
           'PIPE_BUF', '_ISlower', 'AV_PKT_DATA_PARAM_CHANGE',
           ...
           'av_packet_new_side_data', '__pthread_internal_slist',
           ...
           'AV_CODEC_ID_ESCAPE124', 'FF_COMPRESSION_DEFAULT',
           'ELIBEXEC', 'sws_scale', 'FF_LAMBDA_MAX',
           'AVFMT_NOTIMESTAMPS', 'LIBAVCODEC_VERSION_INT',
           '_POSIX2_LINE_MAX', 'EIO', 'feof_unlocked',
           'AV_CODEC_ID_SSA', '_G_HAVE_LONG_DOUBLE_IO', 'remquo',
           '_POSIX_MAX_CANON', 'memchr', 'PIX_FMT_YUV411P', 'gets',
           ...
           '_XOPEN_LIM_H', 'N4wait4DOT_15E',
           'SWS_SRC_V_CHR_DROP_SHIFT', 'CODEC_ID_8SVX_FIB',
           'av_frame_get_channels', 'isalnum_l', 'ENETUNREACH',
           '_XOPEN_IOV_MAX', 'AV_CODEC_ID_VC1IMAGE',
           'AV_LOCK_RELEASE', '_G_NAMES_HAVE_UNDERSCORE',
           'AV_CODEC_ID_MP1', '_IO_NO_READS', 'AV_CODEC_ID_MP3',
           'AV_CODEC_ID_MP2', '__GLIBC_MINOR__', 'CODEC_ID_PROBE',
           'FF_DEBUG_BUGS', 'CODEC_ID_MSS1', 'strrchr', '__strtok_r',
           'pthread_barrier_t', 'pthread_rwlock_t', 'ADJ_MAXERROR',
           'tzset', 'av_filter_next', 'MB_TYPE_INTRA16x16', 'labs',
           ...
           'AV_CODEC_ID_VMDAUDIO', 'AV_CH_LAYOUT_7POINT1_WIDE',
           'putchar', 'SLICE_FLAG_ALLOW_FIELD', 'CODEC_ID_S302M',
           'av_hex_dump', 'avio_wl16', 'AV_CODEC_ID_AAC_LATM',
           'major', 'FF_IDCT_INT', 'AVERROR_MUXER_NOT_FOUND',
           'avfilter_copy_buffer_ref_props', 'pthread_spinlock_t',
           '_IO_seekoff', 'setbuf',
           ...
           'SWS_CPU_CAPS_MMXEXT', '_BITS_TIMEX_H',
           'av_get_media_type_string', '__isupper_l',
           'AVFilterCommand', '__USE_LARGEFILE',
           'SWS_MAX_REDUCE_CUTOFF', '_FEATURES_H',
           'av_get_profile_name', 'WCONTINUED', 'CODEC_ID_SP5X',
           'gmtime_r', 'vsnprintf', 'AVERROR_STREAM_NOT_FOUND',
           '_POSIX_SEM_NSEMS_MAX', 'CODEC_ID_ILBC',
           'AVFilterBufferRefVideoProps', 'nearbyintl',
           'CODEC_FLAG2_CHUNKS', 'pselect', 'CODEC_ID_TXD',
           'avformat_seek_file', 'AVFMT_FLAG_SORT_DTS', 'SING',
           'rename', 'EPFNOSUPPORT', 'sys_nerr', 'AV_PERM_ALIGN',
           'ADJ_STATUS', 'strtoul_l', 'av_get_bits_per_sample_fmt',
           'ENOKEY', 'PP_FORMAT_411', 'timeval', 'CODEC_ID_RA_288',
           ...
           'exp', 'AV_CODEC_ID_MSA1', 'LIBAVDEVICE_VERSION_MINOR',
           ...
           'lrand48_r', 'FF_DEBUG_BUFFERS', 'strtof_l',
           ...
           'CODEC_ID_ADPCM_4XM', 'tgamma', 'atof', 'ME_TESA',
           ...
           'CODEC_CAP_EXPERIMENTAL', 'islessequal', 'av_ext2dbl',
           ...
           'rand_r', 'AV_CH_TOP_FRONT_RIGHT', 'FF_BUFFER_TYPE_USER',
           'AV_CODEC_ID_SIPR', 'PP_PICT_TYPE_QP2', 'y0f', 'MAX_CANON',
           ...
           'M_2_SQRTPI', 'AV_CODEC_ID_MJPEG', '__exception',
           'N4wait4DOT_16E', 'AV_DICT_DONT_STRDUP_KEY',
           'CODEC_ID_JPEG2000', 'asinl', 'asinf',
           'av_packet_merge_side_data', 'AVFMT_SEEK_TO_PTS',
           ...
           'CODEC_CAP_NEG_LINESIZES', 'AV_CODEC_ID_ATRAC1', 'malloc',
           'scalblnf', 'AV_CLASS_CATEGORY_FILTER', 'AV_CODEC_ID_CAVS',
           '__DEV_T_TYPE', '__WTERMSIG', 'FF_IDCT_MMI',
           ...
           'scalbl', '_G_size_t', 'CODEC_ID_CYUV', 'nextafter',
           'va_copy', 'scalbn', 'AV_CODEC_ID_ADPCM_XA', 'PP_FORMAT',
           '_IO_IS_FILEBUF', 'SEEK_SET', '__io_write_fn',
           'av_parser_parse2', 'FF_CMP_ZERO', 'SUBTITLE_ASS',
           'sws_getContext', 'ECHRNG', 'sws_printVec2',
           ...
           '_LARGEFILE_SOURCE', 'AVERROR_FILTER_NOT_FOUND', 'mempcpy',
           'FF_BUFFER_HINTS_PRESERVE', 'CODEC_ID_8SVX_RAW',
           'AV_PERM_NEG_LINESIZES', '_IO_LEFT', '__isdigit_l',
           'av_hex_dump_log', '_G_off_t', 'dremf', 'CODEC_ID_AURA2',
           'dreml', 'fflush', 'av_get_planar_sample_fmt',
           ...
           'int_least8_t', '_LIB_VERSION_TYPE', 'AV_VERSION_INT',
           'SWS_FAST_BILINEAR', 'AV_DICT_DONT_STRDUP_VAL',
           'AV_CODEC_ID_QDMC', '__signbitl', 'FFMAX3',
           'av_probe_input_format3', 'AVERROR_ENCODER_NOT_FOUND',
           'AV_CODEC_ID_APE', 'AV_CODEC_ID_QDM2', 'isgreaterequal',
           '_G_uint16_t', 'ENOBUFS', 'AVFMT_FLAG_IGNDTS',
           '_BITS_POSIX1_LIM_H', 'FP_SUBNORMAL', 'CODEC_ID_FFVHUFF',
           'PIX_FMT_YUV444P16LE', 'avio_seek_time',
           'FF_BUG_XVID_ILACE', 'AV_CLASS_CATEGORY_BITSTREAM_FILTER',
           'FF_PROFILE_VC1_SIMPLE', 'HUGE_VALF', 'avio_wl32', 'putw',
           '_IO_peekc', 'FF_IDCT_ARM', '__USE_BSD', 'FF_EC_DEBLOCK',
           'AV_MATRIX_ENCODING_DOLBY', 'LIBPOSTPROC_BUILD', 'MOD_TAI',
           ...
           'CODEC_ID_IMC', 'atoi', 'CODEC_ID_TMV',
           'CODEC_ID_LAGARITH',
           ...
           'avcodec_align_dimensions2', 'strtoumax', 'daylight',
           'AVSTREAM_PARSE_FULL_RAW', 'CODEC_ID_SOL_DPCM', 'EMSGSIZE',
           ...
           'AV_CODEC_ID_INDEO5', 'AV_CH_STEREO_LEFT', 'fmodl',
           '__strtoull_internal', 'EPROTOTYPE', 'ENAVAIL',
           ...
           'FF_EC_GUESS_MVS', '__codecvt_noconv', 'FF_DEBUG_SKIP',
           ...
           'PIX_FMT_YUV422P14BE', 'AV_CODEC_ID_PCM_U32BE',
           '_POSIX_OPEN_MAX', 'ldexpf', 'FF_IDCT_EA',
           'LIBAVDEVICE_BUILD', 'log2f', 'fpos_t',
           'AV_CPU_FLAG_ARMV6', 'ME_ITER', 'CODEC_ID_ANM',
           'av_reverse', 'va_end', 'llrintf',
           'avcodec_get_subtitle_rect_class',
           'AV_CH_FRONT_LEFT_OF_CENTER',
           '__SIZEOF_PTHREAD_CONDATTR_T', 'getline', 'FF_DCT_FASTINT',
           ...
           'AVSTREAM_PARSE_FULL', 'isblank', 'AV_CODEC_ID_JPEGLS',
           'ferror', 'snprintf', '_ALLOCA_H', '__errno_location',
           'AV_CODEC_ID_SHORTEN', 'AV_CODEC_ID_PCX', 'strcasestr',
           'AV_CODEC_ID_PCM_BLURAY', 'AV_CH_LAYOUT_NATIVE',
           '__ctype_get_mb_cur_max', 'UINTMAX_C', '__USE_POSIX199309',
           ...
           'CODEC_ID_VC1', 'av_intfloat32', 'AVColorSpace', 'ME_EPZS',
           ...
           'nexttowardf', 'ADJ_NANO', 'FF_BUG_OLD_MSMPEG4',
           'isgraph_l', 'nexttowardl', 'LIBPOSTPROC_VERSION_MINOR',
           'CODEC_ID_JV', 'llrintl', 'PIX_FMT_GBRP14LE',
           'CODEC_CAP_SUBFRAMES', 'BIG_ENDIAN', 'MB_TYPE_8x16',
           '__USE_XOPEN_EXTENDED', 'SEEK_END', 'strftime_l',
           ...
           'PIX_FMT_GRAY8A', 'avio_wl64', 'AV_CPU_FLAG_SSE4',
           ...
           'AV_EF_CAREFUL', 'AV_DISPOSITION_DEFAULT', 'strtod_l',
           'ADJ_FREQUENCY', 'CODEC_ID_OPUS',
           ...
           'STA_FREQHOLD', 'AV_CODEC_ID_BMP', 'uint_least64_t',
           ...
           '__int32_t', 'AVFMT_SHOW_IDS', 'modf', 'EIDRM',
           'EADDRNOTAVAIL', 'FF_DEBUG_MMCO', '_IO_NO_WRITES',
           ...
           '__FILE_defined', 'SWS_CS_ITU624', 'AVCOL_RANGE_MPEG',
           ...
           'AV_CODEC_ID_MOTIONPIXELS', 'getpt', '_IO_IS_APPENDING',
           'AV_SAMPLE_FMT_NB', 'mkostemp64', 'copysignf',
           'CODEC_ID_CINEPAK', 'FF_DEBUG_THREADS',
           ...
           'AV_CODEC_ID_PCM_ALAW', '__uint8_t', 'AV_CODEC_ID_AVS',
           '__SIZEOF_PTHREAD_RWLOCK_T', 'av_rescale_rnd', 'strcat',
           'AVFMT_DURATION_FROM_STREAM', 'av_strerror',
           'avpicture_free', 'url_feof', 'CODEC_ID_RALF',
           ...
           'CODEC_ID_MSMPEG4V2', 'AV_CODEC_ID_PCM_F32BE',
           ...
           'CODEC_ID_IAC', 'frexpf', 'CODEC_ID_MSMPEG4V3',
           'AV_CPU_FLAG_MMXEXT', 'tolower', 'AVFMT_FLAG_MP4A_LATM',
           'AV_CODEC_ID_MIMIC', 'EKEYREVOKED',
           'av_default_get_category', 'AV_CODEC_ID_H264',
           'AV_ROUND_INF', 'AV_CODEC_ID_Y41P', 'AVCOL_SPC_YCGCO',
           'LIBSWSCALE_BUILD', '__quad_t', 'av_samples_alloc',
           '_BSD_SOURCE', '__uid_t', 'MATH_ERRNO', 'av_seek_frame',
           '_SVID_', 'AVFMTCTX_NOHEADER', 'LIBAVFILTER_VERSION_MINOR',
           ...
           'FF_PROFILE_AAC_MAIN', '__inline_mathopNP_',
           ...
           'ushort', 'AVPacketList', 'CODEC_ID_PCM_U16LE',
           ...
           'AV_CODEC_ID_CDGRAPHICS', 'L_tmpnam',
           'AV_CH_LAYOUT_7POINT1', 'AV_CODEC_ID_RA_288',
           'CODEC_ID_DSICINVIDEO', 'tmpfile64', 'CODEC_FLAG_GMC',
           'MOD_MICRO', 'av_samples_fill_arrays', '__isnanf',
           'getsubopt', 'av_picture_pad',
           'avcodec_get_context_defaults', 'CODEC_ID_HUFFYUV',
           'AVFilterPool', 'obstack', 'WIFEXITED', 'FF_IDCT_VP3',
           'AV_CODEC_ID_PCM_DVD', 'va_arg', 'FP_ILOGBNAN',
           'av_audio_resample_init', '_IO_2_1_stderr_',
           'AV_SAMPLE_FMT_NONE', 'AV_CODEC_ID_NUV',
           'PIX_FMT_BGR565BE', 'ELIBSCN', 'LIBAVUTIL_BUILD',
           'PIX_FMT_BGR8', 'CODEC_ID_WMAV1', 'av_gettime',
           'CODEC_ID_ADPCM_EA_MAXIS_XA', 'AV_CODEC_ID_PGMYUV',
           '_BITS_BYTESWAP_H', 'cos', 'WSTOPSIG', '__dev_t',
           '_IO_HAVE_SYS_WAIT', 'AV_CH_LAYOUT_6POINT0_FRONT',
           '_SYS_SYSMACROS_H', 'av_parser_change',
           'AV_CODEC_ID_JPEG2000', 'drand48', 'truncl',
           'av_dict_copy', 'LIBAVFORMAT_VERSION_MICRO', 'truncf',
           ...
           'AV_CODEC_ID_A64_MULTI', '__USE_POSIX199506', '__S64_TYPE',
           'av_close_input_file', '__BIG_ENDIAN', 'log10f',
           'AV_PKT_DATA_JP_DUALMONO', 'uintmax_t', 'EACCES',
           '__WCHAR_MAX', 'AV_CH_LAYOUT_2_1', 'AV_CH_LAYOUT_2_2',
           'PLOSS', 'ispunct', 'getloadavg', 'ino_t',
           '_POSIX2_BC_STRING_MAX', '__W_EXITCODE',
           'FF_CODER_TYPE_AC', 'sqrt', 'AV_CODEC_ID_ASV2',
           'AV_CODEC_ID_ASV1', '__fsblkcnt64_t',
           'AV_CODEC_ID_ADPCM_SBPRO_4', 'AV_CODEC_ID_ADPCM_SBPRO_3',
           'AV_CODEC_ID_ADPCM_SBPRO_2', 'PIX_FMT_BGRA64LE',
           'FF_DEBUG_VIS_MV_B_FOR', 'avcodec_get_type',
           'av_find_best_stream', 'AV_CODEC_ID_PCM_U24LE', 'av_mul_q',
           ...
           'powf', '__MATHCALLX', 'be16toh', 'WSTOPPED',
           'N8AVStream4DOT_38E', 'rintf', 'av_codec_get_id',
           '_TIME_H', '__SIZEOF_PTHREAD_BARRIERATTR_T',
           'avformat_close_input', 'AV_NE', 'AVSEEK_SIZE', '__isinfl',
           'CODEC_ID_PCX', 'ESOCKTNOSUPPORT', 'AVDISCARD_ALL',
           ...
           '__compar_fn_t', 'AV_CODEC_ID_MDEC', 'modfl',
           ...
           'AVERROR_UNKNOWN', 'htole64', '__stpncpy', 'EINTR', 'EADV',
           'INT8_C', 'strlen', 'AVCOL_RANGE_JPEG',
           'sws_convertPalette8ToPacked24', 'AV_CODEC_ID_MICRODVD',
           'ENOSYS', 'u_int', 'puts', 'PP_FORMAT_444', 'av_resample',
           ...
           'CODEC_ID_INDEO3', 'SLICE_FLAG_CODED_ORDER',
           '_ISOC11_SOURCE', 'AV_CODEC_ID_AASC',
           'CODEC_ID_MPEG1VIDEO', 'AV_CODEC_ID_S302M', 'tzname',
           'avcodec_encode_video2', 'CODEC_ID_INTERPLAY_DPCM',
           'isprint', 'avcodec_find_best_pix_fmt', '__USE_UNIX98',
           'fgets_unlocked', 'WIFCONTINUED', '__gid_t',
           'PIX_FMT_XVMC_MPEG2_IDCT', 'CODEC_ID_ADPCM_CT',
           'FF_LOSS_COLORSPACE', 'AV_CH_LAYOUT_5POINT1_BACK',
           ...
           'AV_CODEC_ID_FLASHSV', 'CLOCK_PROCESS_CPUTIME_ID',
           ...
           '__codecvt_error', 'CODEC_ID_MTS2', 'remainderf',
           'FF_IDCT_AUTO', '_toupper', 'remainderl', 'getdate_err',
