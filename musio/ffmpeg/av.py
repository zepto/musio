...
__issignaling = _libraries['/usr/lib/libavcodec.so'].__issignaling
__issignaling.restype = c_int
__issignaling.argtypes = [c_double]
__issignalingf = _libraries['/usr/lib/libavcodec.so'].__issignalingf
__issignalingf.restype = c_int
__issignalingf.argtypes = [c_float]
__issignalingl = _libraries['/usr/lib/libavcodec.so'].__issignalingl
...
av_codec_get_seek_preroll = _libraries['/usr/lib/libavcodec.so'].av_codec_get_seek_preroll
av_codec_get_seek_preroll.restype = c_int
av_codec_get_seek_preroll.argtypes = [POINTER(AVCodecContext)]
av_codec_set_seek_preroll = _libraries['/usr/lib/libavcodec.so'].av_codec_set_seek_preroll
...
av_codec_get_max_lowres = _libraries['/usr/lib/libavcodec.so'].av_codec_get_max_lowres
...
av_packet_free_side_data = _libraries['/usr/lib/libavcodec.so'].av_packet_free_side_data
av_packet_free_side_data.restype = None
av_packet_free_side_data.argtypes = [POINTER(AVPacket)]
av_packet_ref = _libraries['/usr/lib/libavcodec.so'].av_packet_ref
av_packet_ref.restype = c_int
av_packet_ref.argtypes = [POINTER(AVPacket), POINTER(AVPacket)]
av_packet_unref = _libraries['/usr/lib/libavcodec.so'].av_packet_unref
av_packet_unref.restype = None
av_packet_unref.argtypes = [POINTER(AVPacket)]
av_packet_move_ref = _libraries['/usr/lib/libavcodec.so'].av_packet_move_ref
av_packet_move_ref.restype = None
av_packet_move_ref.argtypes = [POINTER(AVPacket), POINTER(AVPacket)]
av_packet_copy_props = _libraries['/usr/lib/libavcodec.so'].av_packet_copy_props
...
avcodec_enum_to_chroma_pos = _libraries['/usr/lib/libavcodec.so'].avcodec_enum_to_chroma_pos
avcodec_enum_to_chroma_pos.restype = c_int
avcodec_enum_to_chroma_pos.argtypes = [POINTER(c_int), POINTER(c_int), AVChromaLocation]
avcodec_chroma_pos_to_enum = _libraries['/usr/lib/libavcodec.so'].avcodec_chroma_pos_to_enum
...
av_probe_input_buffer2 = _libraries['/usr/lib/libavformat.so'].av_probe_input_buffer2
...
av_frame_get_colorspace = _libraries['/usr/lib/libavcodec.so'].av_frame_get_colorspace
av_frame_get_colorspace.restype = AVColorSpace
av_frame_get_colorspace.argtypes = [POINTER(AVFrame)]
av_frame_set_colorspace = _libraries['/usr/lib/libavcodec.so'].av_frame_set_colorspace
av_frame_set_colorspace.restype = None
av_frame_set_colorspace.argtypes = [POINTER(AVFrame), AVColorSpace]
av_frame_get_color_range = _libraries['/usr/lib/libavcodec.so'].av_frame_get_color_range
av_frame_get_color_range.restype = AVColorRange
av_frame_get_color_range.argtypes = [POINTER(AVFrame)]
av_frame_set_color_range = _libraries['/usr/lib/libavcodec.so'].av_frame_set_color_range
av_frame_set_color_range.restype = None
av_frame_set_color_range.argtypes = [POINTER(AVFrame), AVColorRange]
av_get_colorspace_name = _libraries['/usr/lib/libavcodec.so'].av_get_colorspace_name
...
av_reallocp = _libraries['/usr/lib/libavcodec.so'].av_reallocp
...
av_opt_set_channel_layout = _libraries['/usr/lib/libavcodec.so'].av_opt_set_channel_layout
...
av_opt_get_channel_layout = _libraries['/usr/lib/libavcodec.so'].av_opt_get_channel_layout
...
__all__ = ['AVFMT_NOBINSEARCH', 'CODEC_ID_ADPCM_IMA_AMV', 'ETXTBSY',
           ...
           'CODEC_ID_TIFF', 'SCNuFAST16', 'PRIXFAST32',
           'AV_CODEC_ID_PGM', 'fmod', 'AV_CODEC_ID_VBLE', 'acosl',
           ...
           'PRIoFAST16', 'FF_OPT_TYPE_BINARY', 'sscanf', 'copysign',
           'drem', 'AV_CODEC_ID_OTF', 'setstate_r',
           'LIBAVDEVICE_IDENT', 'av_get_colorspace_name',
           'CODEC_ID_PBM', 'CODEC_ID_FFMETADATA',
           'N14pthread_cond_t4DOT_20E', 'AV_CH_LAYOUT_MONO',
           'FF_RC_STRATEGY_XVID', 'PRIXFAST16', 'av_rescale',
           ...
           '__WTERMSIG', 'PIX_FMT_VDPAU_WMV3', 'PRIXLEAST16', 'M_PHI',
           ...
           'AV_CH_BACK_LEFT', 'SUBTITLE_NONE', 'UINT32_C', 'SCNu8',
           'FFUMOD', '_XOPEN_SOURCE', 'AV_PIX_FMT_GBR24P',
           ...
           'AV_CODEC_ID_PCM_S24BE', 'strtouq', '__glibc_likely',
           'avio_read', 'LIBAVFILTER_IDENT', 'ENOTTY',
           'CODEC_CAP_FRAME_THREADS', '_IONBF', 'finitef',
           'AV_CODEC_ID_PAF_VIDEO', 'AV_CODEC_ID_MSMPEG4V1',
           'AV_CODEC_ID_PCM_S16BE_PLANAR', 'finitel',
           'AV_PICTURE_TYPE_BI', 'SCNoFAST16', 'CODEC_ID_ESCAPE124',
           'AV_PIX_FMT_YUV444P14BE', 'ENOLINK',
           'CODEC_ID_TRUEMOTION1', 'AV_CODEC_ID_RV40',
           'av_write_trailer', 'CODEC_ID_TRUEMOTION2', 'AV_FIELD_BB',
           'INT_LEAST16_MAX', 'AV_CODEC_ID_MSMPEG4V2', 'EMLINK',
           ...
           'AV_PIX_FMT_GBRP16BE', 'CODEC_ID_BMV_AUDIO',
           ...
           'PRIuLEAST64', 'FF_CMP_SSE', 'av_get_frame_filename',
           'AV_ROUND_ZERO', '_SYS_CDEFS_H',
           ...
           'av_find_stream_info', 'CODEC_ID_DIRAC', 'pid_t', 'AVFrac',
           'MB_TYPE_INTRA_PCM', 'uint_fast32_t',
           'AV_CODEC_ID_VMDVIDEO', 'div_t', '_IO_IS_FILEBUF',
           'AV_CODEC_ID_THP', 'sprintf', 'av_free_packet',
           'AVFMT_NOSTREAMS', 'av_frame_set_best_effort_timestamp',
           'CHARCLASS_NAME_MAX', 'SCNuLEAST16',
           'LIBSWSCALE_VERSION_MICRO', 'AV_CODEC_ID_CMV', 'log2',
           'AV_CODEC_ID_AIC', 'AV_OPT_TYPE_PIXEL_FMT',
           'AV_PIX_FMT_YUV422P9LE', 'AV_CODEC_ID_OPUS',
           'SWS_BITEXACT', 'av_opt_eval_float', 'PIX_FMT_GBRP10BE',
           'AV_CODEC_ID_MJPEGB', 'PRId64', 'L_cuserid',
           'av_get_picture_type_char', 'PIX_FMT_YUV422P12BE',
           'av_add_q', 'MB_TYPE_INTERLACED', 'AVBuffer',
           'av_frame_get_channel_layout', 'FF_IDCT_FAAN',
           ...
           'AVFILTER_AUTO_CONVERT_ALL', '__suseconds_t',
           'av_packet_free_side_data', 'AV_DISPOSITION_FORCED',
           'avresample_version', 'floorl', 'avfilter_register_all',
           'SCNi16', 'FF_MB_DECISION_RD', 'ldexp', '_IO_lock_t',
           '_POSIX2_COLL_WEIGHTS_MAX', '__SIZEOF_PTHREAD_MUTEXATTR_T',
           'CODEC_ID_ROQ', 'av_reallocp_array', 'strncpy',
           'CODEC_ID_ATRAC3P', 'FP_ILOGB0', 'avcodec_set_dimensions',
           '_sys_nerr', 'exp2', 'AV_AUDIO_SERVICE_TYPE_VOICE_OVER',
           'qsort', 'PIX_FMT_ARGB', 'avio_printf',
           ...
           'FF_CODER_TYPE_DEFLATE', 'ESRCH', 'FF_DEBUG_VIS_MV_B_FOR',
           ...
           'posix_memalign', 'FF_PROFILE_MPEG2_AAC_HE', 'be64toh',
           ...
           'AV_CODEC_ID_XAN_DPCM', 'SCNd8', 'avio_seek', '_XOPEN_',
           '__issignaling', 'CODEC_FLAG_LOOP_FILTER', 'RAND_MAX',
           ...
           'PIX_FMT_YUV444P9LE', 'fcloseall', 'PRIiMAX',
           'avcodec_descriptor_next', 'AV_CODEC_ID_BINTEXT',
           'FF_IDCT_SIMPLENEON', 'avformat_alloc_context', 'SCNi8',
           'strpbrk', 'FF_DEBUG_MV', 'PRIdPTR', 'MB_TYPE_P0L1',
           ...
           'N4wait4DOT_10E', 'AV_CODEC_ID_FRAPS', 'AVSEEK_FORCE',
           'FF_DEBUG_QP', 'avcodec_find_encoder', 'AVPacket',
           'ENOTCONN', 'mrand48', 'AV_DICT_DONT_OVERWRITE',
           'CODEC_ID_MDEC', 'floor', 'SWS_FULL_CHR_H_INP',
           'AV_CODEC_ID_C93', 'SWS_FULL_CHR_H_INT', 'htobe32',
           'AV_PIX_FMT_RGB48BE', 'CODEC_ID_CELT', 'BUFSIZ',
           'FF_BUG_AMV', '_POSIX_LOGIN_NAME_MAX', 'PRIoLEAST64',
           ...
           'intmax_t', 'useconds_t', 'CODEC_ID_SSA',
           'av_get_channel_name', 'AV_CODEC_ID_PCM_U8', 'gets',
           'SCNuLEAST32', 'CODEC_ID_WS_VQA', 'ENOTBLK',
           'MB_TYPE_INTRA16x16', 'AVChromaLocation', 'CODEC_ID_AVUI',
           'AV_PIX_FMT_YUV420P12LE', 'avio_wb24',
           'AV_AUDIO_SERVICE_TYPE_COMMENTARY', 'CODEC_ID_TEXT',
           'MATH_ERREXCEPT', 'offsetof', 'BC_BASE_MAX',
           'CODEC_ID_MP2', 'CODEC_ID_MP3', 'ecvt', 'NFDBITS',
           'AV_PIX_FMT_0RGB', 'WTERMSIG', '_POSIX_HIWAT',
           'FF_THREAD_SLICE', 'ENOPKG', 'CODEC_ID_WAVPACK',
           'AV_OPT_FLAG_AUDIO_PARAM', 'CODEC_ID_AAC',
           'avio_get_str16le', 'AV_CPU_FLAG_SSE', 'mkostemp64',
           'AV_CODEC_ID_MSRLE', 'av_codec_get_max_lowres', 'fread',
           'fsetpos', 'AV_CODEC_ID_G2M', 'uint_fast16_t',
           ...
           'AV_PIX_FMT_YUVA444P10BE', 'FF_PROFILE_H264_INTRA',
           ...
           'ME_TESA', 'AV_PIX_FMT_RGB0', '_IO_FILE',
           ...
           'fopen', 'AV_PIX_FMT_UYYVYY411', 'strtok', 'FF_DCT_MMX',
           'lroundl', 'av_get_channel_description',
           'av_frame_move_ref', 'M_LN10', 'AV_CODEC_ID_CLJR', 'SCNx8',
           'nextafter', 'AV_PICTURE_TYPE_SP', 'CODEC_FLAG_EMU_EDGE',
           'strtof', '_LARGEFILE_SOURCE', 'FF_CMP_DCTMAX',
           'CODEC_ID_AURA', 'FF_PROFILE_H264_CONSTRAINED_BASELINE',
           'FF_BUG_STD_QPEL', 'srand', 'av_set_int', 'bzero',
           'AV_PIX_FMT_GBRAP16LE', 'FF_PROFILE_DTS_HD_HRA',
           ...
           'AV_CODEC_ID_PCM_U16LE', 'y1f', 'avpicture_alloc',
           ...
           'ftrylockfile', '_IO_peekc', 'AV_CODEC_ID_NELLYMOSER',
           ...
           'FF_DEBUG_DCT_COEFF', 'ENOTDIR', 'AV_CODEC_ID_PCM_F32BE',
           ...
           'SCNu64', 'AV_CODEC_ID_OPUS_DEPRECATED',
           ...
           'size_t', 'avio_pause', 'seed48', 'MAX_INPUT',
           'AV_CODEC_ID_012V', 'CODEC_FLAG_4MV', 'AV_CODEC_ID_TQI',
           'AVMEDIA_TYPE_ATTACHMENT', 'CODEC_ID_RL2', 'roundf',
           'AV_CH_BACK_CENTER', 'PIX_FMT_BGR8', 'PIX_FMT_VDPAU_MPEG1',
           'PIX_FMT_BGR4', 'FF_CMP_DCT264', 'PIX_FMT_VDPAU_MPEG2',
           'CODEC_ID_V308', 'sws_init_context',
           ...
           'CODEC_ID_PCM_S24LE', 'CODEC_ID_TTA', 'SCHAR_MIN',
           ...
           'CODEC_ID_WNV1', 'av_opt_get_pixel_fmt',
           'LIBPOSTPROC_VERSION_MAJOR', 'stderr',
           ...
           'PRIuLEAST32', 'av_int2flt', 'AV_CODEC_ID_WEBP',
           'EKEYREJECTED', 'FF_IDCT_XVIDMMX', 'AVCOL_RANGE_NB',
           ...
           'AVRational', 'EUNATCH', 'WNOWAIT', 'AV_SAMPLE_FMT_U8',
           'AV_TOSTRING', 'strxfrm', 'avcodec_get_frame_class',
           'AV_PIX_FMT_GBRP12BE', 'SCNiFAST64', 'cbrtf',
           ...
           'AV_CODEC_ID_AMV', 'av_d2q', 'INT_FAST8_MAX', '_XLOCALE_H',
           'logbf', 'AV_CPU_FLAG_ARMV6T2',
           'FF_SUB_CHARENC_MODE_AUTOMATIC', 'CODEC_ID_DXTORY',
           'AV_PIX_FMT_RGB48LE', '__finitel', 'AV_CODEC_ID_RAWVIDEO',
           'AV_LOG_INFO', 'CODEC_ID_C93', 'fsblkcnt_t', 'PATH_MAX',
           'avcodec_find_best_pix_fmt_of_2', 'av_add_index_entry',
           'WINT_MAX', 'PixelFormat', 'fscanf', 'AV_CH_BACK_RIGHT',
           'AV_GLUE', 'FF_DEBUG_VIS_MB_TYPE',
           'FF_COMPLIANCE_UNOFFICIAL', 'AV_PIX_FMT_YUV422P14BE',
           '__FD_ZERO_STOS', 'AVFMT_TS_NEGATIVE',
           'AV_CODEC_ID_SUBRIP', 'obstack_vprintf', 'atol',
           'AV_CODEC_ID_ADPCM_ADX', 'AV_PIX_FMT_BAYER_BGGR16LE',
           'AV_CODEC_ID_BINKAUDIO_DCT',
           'AV_AUDIO_SERVICE_TYPE_EMERGENCY', 'INT_LEAST32_MIN',
           ...
           '__USE_XOPEN2K', 'avcodec_enum_to_chroma_pos',
           'avcodec_open2', 'AV_PIX_FMT_YUYV422', 'jn',
           'FF_BUG_DIRECT_BLOCKSIZE', 'AVProfile', 'ME_HEX',
           ...
           '__vsnprintf_chk', 'AV_SIDE_DATA_PARAM_CHANGE_DIMENSIONS',
           'AV_PIX_FMT_RGB555LE', 'pow', 'SWS_CS_SMPTE170M',
           '__PTHREAD_RWLOCK_INT_FLAGS_SHARED', 'AVFMT_NOTIMESTAMPS',
           'AV_OPT_TYPE_FLOAT', 'avfilter_inout_free',
           'av_dynarray2_add', 'AVCHROMA_LOC_TOPLEFT',
           'CODEC_ID_DSICINAUDIO', 'EBADMSG', 'blkcnt_t',
           'AVClassCategory', 'AV_EF_BITSTREAM', 'ilogbf',
           ...
           'strtoimax', '_POSIX2_LINE_MAX', 'AV_PIX_FMT_YUV420P9BE',
           ...
           'CODEC_ID_MP3ADU', 'AV_PIX_FMT_BAYER_GBRG8', 'LONG_BIT',
           ...
           'AV_CODEC_ID_ULTI', 'avfilter_ref_buffer', 'INT16_C',
           'PRIoLEAST32', 'CODEC_ID_PRORES', 'CODEC_ID_V410',
           ...
           'CODEC_ID_VC1IMAGE', 'AV_PIX_FMT_VDPAU_VC1', 'lrintf',
           ...
           'PRIu8', 'av_opt_set_from_string', 'fgets',
           'AV_CODEC_ID_R210', 'NL_LANGMAX', 'cookie_io_functions_t',
           'SWS_X', 'ELIBBAD', 'avcodec_fill_audio_frame', 'ERANGE',
           'exp2l', 'FF_PROFILE_VC1_MAIN', 'LIBAVFORMAT_VERSION_INT',
           'ftell', 'AV_CODEC_ID_WMAV1', 'FF_IDCT_IPP',
           'AV_CODEC_ID_WMAV2', 'avfilter_pad_get_name', 'PRIi64',
           ...
           'tgammaf', 'AV_CODEC_ID_TAK', 'SWS_BICUBIC', 'getsubopt',
           'CODEC_ID_VMNC', 'PRIuLEAST8', 'avfilter_get_by_name',
           ...
           'avformat_get_class', 'PRIuFAST64', 'FF_PRED_PLANE',
           ...
           '__SIZEOF_PTHREAD_MUTEX_T', 'av_flt2int', '_IO_STDIO',
           ...
           'av_opt_set_int', 'CODEC_ID_DNXHD', 'INTPTR_MAX',
           'avfilter_execute_func', 'AV_CODEC_ID_DSICINAUDIO',
           'av_opt_set_pixel_fmt', 'AV_CODEC_ID_RA_144',
           'CODEC_ID_MP1', 'PRIdLEAST8', 'FF_CODER_TYPE_RAW',
           'CODEC_ID_SMC', 'LIBAVCODEC_VERSION_MAJOR', 'ETOOMANYREFS',
           ...
           'av_dbl2ext', 'makedev', 'AVRESAMPLE_MAX_CHANNELS',
           '__realpath_chk', 'av_parser_change', 'ENOTSUP',
           'AV_LOG_WARNING', 'AVFMT_FLAG_FLUSH_PACKETS',
           'CODEC_ID_ADPCM_G722', 'avio_rb32', 'INT_FAST16_MIN',
           'vscanf', 'CODEC_ID_ADPCM_G726', 'avpicture_deinterlace',
           'SWS_PRINT_INFO', 'SCNu32', 'AV_PIX_FMT_GRAY16BE',
           ...
           'AV_PIX_FMT_YUV422P16LE', '_IO_jump_t',
           'AV_PIX_FMT_YUV444P12BE', 'AV_CODEC_ID_XSUB',
           'ENAMETOOLONG', 'av_int_list_length_for_size',
           'fputc_unlocked', 'ldexpl', 'M_PI_2', 'av_opt_get',
           '__uint64_t', 'FF_PROFILE_DTS_HD_MA', 'M_PI_4',
           'AV_CODEC_ID_MSVIDEO1', 'AVFMT_DURATION_FROM_PTS', 'ELOOP',
           'FF_DTG_AFD_SAME', 'AV_CODEC_ID_ADPCM_IMA_ISS',
           'av_opt_eval_q', 'PRIXFAST64', 'AV_PIX_FMT_YUVA444P10LE',
           'AVFMT_SHOW_IDS', '_IO_off_t', 'y1l',
           'AV_CODEC_ID_PCM_S32LE_PLANAR', 'PIX_FMT_VDPAU_H264',
           'nanl', 'av_frame_set_qp_table', 'AV_PERM_READ',
           'USHRT_MAX', 'av_int2dbl', 'SCNoLEAST64',
           ...
           'pthread_barrierattr_t', '__strtol_internal',
           ...
           'SCNoLEAST16', 'av_set_pts_info', 'AVCodecContext',
           'FF_IDCT_SH4', 'M_2_PI', 'AV_CODEC_ID_VB', 'atanh',
           'av_codec_get_tag2', 'atanl', 'AV_OPT_TYPE_STRING',
           'EAFNOSUPPORT', 'avio_close_dyn_buf', 'putc_unlocked',
           'CODEC_FLAG_CLOSED_GOP', 'AV_CODEC_ID_MOV_TEXT',
           'AV_PIX_FMT_NV20BE', 'AVFilterGraphInternal',
           ...
           'AVCOL_PRI_BT470BG', 'avio_wl16', 'INT_FAST16_MAX',
           '__key_t', 'AV_CODEC_ID_RPZA', 'AV_CODEC_ID_ADPCM_IMA_WS',
           ...
           'AV_CODEC_ID_PCM_U24BE', 'AV_PIX_FMT_NV16', '__WCOREDUMP',
           'AV_PIX_FMT_NV12', 'strcasecmp_l', 'FF_PRED_MEDIAN',
           'ferror_unlocked', 'y1', 'EAGAIN', '__error_t_defined',
           'XATTR_SIZE_MAX', 'AV_CODEC_ID_ESCAPE124', 'EMSGSIZE',
           'floorf', 'ELIBEXEC', 'sws_scale', 'FF_LAMBDA_MAX',
           'AV_PIX_FMT_BAYER_RGGB16LE', 'AV_OPT_FLAG_SUBTITLE_PARAM',
           'LIBAVCODEC_VERSION_INT', 'AV_PIX_FMT_YUV440P', 'EIO',
           'feof_unlocked', 'AV_CODEC_ID_DVB_TELETEXT',
           'FF_API_R_FRAME_RATE', 'remquo', '_POSIX_MAX_CANON',
           'memchr', 'PIX_FMT_YUV411P', '_IO_RIGHT', '_IOS_APPEND',
           'av_frame_get_buffer', 'SWS_GAUSS', 'FF_OPT_TYPE_DOUBLE',
           ...
           'AV_CODEC_ID_ADPCM_SWF', '__blksize_t', 'CODEC_ID_AVRP',
           ...
           'AV_CODEC_ID_AAC_LATM', 'major', 'FF_IDCT_INT',
           'PRIdFAST32', 'AV_PIX_FMT_BGR555BE',
           ...
           'av_get_bits_per_sample_fmt', 'PP_CPU_CAPS_AUTO', 'ENOKEY',
           'PP_FORMAT_411', '__USE_POSIX199309', 'CODEC_ID_RA_288',
           'FF_PROFILE_MPEG2_422', 'av_get_channel_layout',
           'AVCOL_TRC_BT709', '_IO_UNBUFFERED',
           'CODEC_ID_BINKAUDIO_RDFT', 'CODEC_CAP_NEG_LINESIZES',
           ...
           '__MATHCALLX', 'LIBAVDEVICE_VERSION_MINOR', 'ENOANO',
           'strncasecmp', 'SWS_BICUBLIN', 'PIX_FMT_YUV410P',
           'CODEC_ID_GSM_MS', 'AVProgram', 'PRIxLEAST32', 'UINT8_C',
           'AVSTREAM_PARSE_FULL', 'mode_t', 'AV_CODEC_ID_ASS',
           ...
           'CODEC_ID_INTERPLAY_VIDEO', 'AV_CODEC_ID_SMACKAUDIO',
           '__have_pthread_attr_t', 'SCNo8', 'PIX_FMT_BGR565LE',
           'AV_CODEC_ID_RV20', 'avresample_read', 'rintl',
           'FF_BUFFER_TYPE_SHARED', 'AV_CODEC_ID_PCM_F32LE',
           ...
           'avutil_license', 'PRIxPTR', 'fd_mask',
           'AV_CODEC_ID_FFWAVESYNTH', 'AV_ROUND_DOWN',
           ...
           'PRIo32', 'SCNi64', 'av_packet_unref', '_IO_uid_t',
           ...
           'AVIndexEntry', 'AV_PIX_FMT_RGBA', 'EWOULDBLOCK',
           'AV_CODEC_ID_MP3ADU', '__USE_XOPEN2K8XSI', 'scalbl',
           'CODEC_ID_CYUV', 'LIBAVRESAMPLE_VERSION_MICRO', 'PRIiPTR',
           'AV_CODEC_ID_HEVC', 'va_copy', 'scalbn',
           'AV_CODEC_ID_ADPCM_XA', 'PP_FORMAT',
           'AV_PIX_FMT_YUVA420P16BE', 'SEEK_SET', '__io_write_fn',
           '_IOS_OUTPUT', 'getloadavg', 'SUBTITLE_ASS',
           ...
           'SCNxLEAST8', 'AVERROR_FILTER_NOT_FOUND', 'mempcpy',
           ...
           'AV_MIX_COEFF_TYPE_Q8', 'register_t', 'lrand48_r',
           'postproc_license', 'CODEC_ID_LJPEG', 'CODEC_ID_G723_1',
           'strstr', 'renameat', '__fgets_unlocked_chk',
           '_POSIX_TIMER_MAX', 'mblen', 'pp_free_mode',
           'CODEC_ID_MOTIONPIXELS', 'AVCHROMA_LOC_BOTTOMLEFT',
           '_IO_vfprintf', 'avcodec_get_name', '__LONG_LONG_PAIR',
           ...
           'FP_SUBNORMAL', 'AV_OPT_TYPE_DURATION', 'CODEC_ID_FFVHUFF',
           ...
           'CODEC_ID_ZMBV', 'FF_IDCT_ARM', 'avresample_get_delay',
           '__USE_BSD', 'SCNoFAST64', 'FF_EC_DEBLOCK',
           'AV_MATRIX_ENCODING_DOLBY', 'LIBPOSTPROC_BUILD', 'FFMIN3',
           'fmin', 'AV_PIX_FMT_GRAY8A', 'SCNoMAX', '_IOS_NOREPLACE',
           'tanhl', 'AV_CODEC_ID_SMACKVIDEO', '_IO_USER_BUF',
           'avfilter_next', 'AV_CODEC_ID_UTVIDEO', 'AV_CPU_FLAG_AVX',
           ...
           'COLL_WEIGHTS_MAX', 'PRIXMAX', 'sws_subVec',
           ...
           'AV_CODEC_ID_INDEO2', 'AV_CODEC_ID_INDEO3',
           ...
           'LIBAVDEVICE_BUILD', 'log2f', 'CODEC_ID_V408', 'fpos_t',
           'AV_CPU_FLAG_ARMV6', 'ME_ITER', 'AV_CODEC_ID_EVRC',
           ...
           'AV_PIX_FMT_BGR565BE', 'PRIoFAST64', 'AV_CODEC_ID_VORBIS',
           ...
           'CODEC_ID_H263', 'CODEC_ID_XBM', 'AV_CODEC_ID_JPEGLS',
           'ferror', 'INT_FAST64_MIN', 'ENOSPC', '_ALLOCA_H',
           ...
           'av_opt_eval_int', 'PRIoPTR', 'AV_CODEC_ID_PJS',
           ...
           '__WCLONE', '__loff_t', 'ENOTEMPTY', 'CODEC_ID_AVS',
           '_POSIX_SEM_VALUE_MAX', 'UINTMAX_MAX', 'UNDERFLOW',
           ...
           'AV_PIX_FMT_YUV422P12BE', 'fcvt', 'FF_MAX_B_FRAMES',
           ...
           'CODEC_ID_FLASHSV2', '_IO_ftrylockfile', 'log', 'fseeko',
           'u_char', 'CODEC_ID_SMACKVIDEO', 'key_t', 'CODEC_ID_FLIC',
           ...
           'AV_CODEC_ID_SP5X', 'SCNiFAST8', 'CODEC_ID_8SVX_EXP',
           ...
           'avcodec_descriptor_get', 'NL_ARGMAX', 'AVFilterInOut',
           'av_samples_copy', 'uintptr_t', 'avio_close',
           'av_dict_get', 'FP_ZERO', 'av_get_exact_bits_per_sample',
           ...
           'av_codec_set_seek_preroll', 'AV_CODEC_PROP_BITMAP_SUB',
           'AV_PIX_FMT_YUV444P', 'AV_CPU_FLAG_MMXEXT', 'ssize_t',
           ...
           'SCNdFAST32', 'AVCOL_SPC_YCGCO', 'LIBSWSCALE_BUILD',
           ...
           'PRId16', 'SWS_SPLINE', 'PIX_FMT_RGB8',
           ...
           'av_dict_parse_string', 'av_packet_ref', 'av_new_stream',
           'AV_CODEC_ID_CINEPAK', 'pp_context',
           '_IO_DELETE_DONT_CLOSE',
           'AV_AUDIO_SERVICE_TYPE_HEARING_IMPAIRED', 'MB_TYPE_QUANT',
           'INTMAX_MAX', 'AVSubtitleType', 'AVResampleContext',
           ...
           'ENXIO', 'AV_PIX_FMT_VDPAU_MPEG2', 'ECONNREFUSED',
           'AV_CODEC_ID_CDGRAPHICS', 'AV_CODEC_ID_PCM_U32BE',
           'AV_CH_LAYOUT_7POINT1', 'AV_CODEC_ID_RA_288',
           'CODEC_ID_DSICINVIDEO', 'tmpfile64', 'av_find_opt',
           'CODEC_FLAG_GMC', '__USE_MISC', '__intptr_t', 'SCNiLEAST8',
           ...
           'av_frame_alloc', 'av_opt_show2', 'AV_CH_LAYOUT_2_1',
           'AV_CH_LAYOUT_2_2', 'AVFrameSideData', 'PLOSS',
           'SCNoFAST32', 'ino_t', '_POSIX2_BC_STRING_MAX',
           ...
           'PIX_FMT_BGRA64LE', 'va_end', 'SWS_SRC_V_CHR_DROP_SHIFT',
           ...
           'FF_CMP_BIT', '__compar_fn_t', 'AV_CODEC_ID_MDEC', 'modfl',
           ...
           'AVERROR_UNKNOWN', 'htole64', '__stpncpy', 'EADDRNOTAVAIL',
           'EADV', 'INT8_C', 'strlen', 'AVCOL_RANGE_JPEG',
           'sws_convertPalette8ToPacked24', 'AV_CODEC_ID_MICRODVD',
           'ENOSYS', 'AV_PIX_FMT_BAYER_BGGR16BE', 'u_int', 'puts',
           ...
           'AVCOL_PRI_SMPTE170M', 'AV_PIX_FMT_BGR8',
           'avfilter_graph_parse_ptr', 'AV_SAMPLE_FMT_S16',
           'AV_PIX_FMT_BGR4', 'AV_PIX_FMT_YUVA420P10LE', 'EOWNERDEAD',
           'AV_PIX_FMT_BGR0', 'CODEC_ID_PAF_AUDIO',
           'av_find_nearest_q_idx', 'ME_PHODS', '_IO_getc',
           ...
           'PRIdMAX', 'AV_CODEC_ID_XBM', 'AV_PIX_FMT_GBRP9LE',
           'AV_CODEC_ID_TSCC', 'PIX_FMT_NV21', 'AV_CH_LAYOUT_3POINT1',
           'SCNxLEAST64', 'av_codec_get_seek_preroll', 'ldiv',
           'strndup', 'CODEC_ID_WMAV2', 'MB_TYPE_L0L1',
           'CODEC_ID_WMAV1', 'asinh', 'av_opt_next', 'jrand48_r',
           'AV_CODEC_ID_INTERPLAY_VIDEO', 'ENETDOWN', 'int64_t',
           'FF_LOSS_DEPTH', 'AV_RESAMPLE_DITHER_TRIANGULAR_HP',
           'av_parse_cpu_caps', 'AV_EF_BUFFER', 'le64toh',
           'AV_CODEC_ID_PCM_U24LE', 'UCHAR_MAX', '__va_copy',
           'EDOTDOT', 'EBADFD', '_IO_MAGIC_MASK', 'CODEC_ID_KMVC',
           ...
           'M_SQRT2', 'PTHREAD_KEYS_MAX', 'EISCONN', 'FF_DEBUG_ER',
